...
VALUES (7, 'Apoio à saúde mental', 'Um apelo ao bem-estar mental da nossa omunidade', 'Existe agora um sistema de atendimento ao estudante via mensagem com profissionais de saúde mental! A comunicação é anónima e qualquer um pode usufruir dela! ');
INSERT INTO post (id_user, title, content)                 -- 8
VALUES (10, 'Podcast de RCOM', 'Para quem estiver interesado em aprofundar os seus conhecimentos de RCOM, a LEIC criou um podcast sobre Redes de Comunicação. Cada episódio terá um tema específico, assim como uma secção dedicada à resposta a comentário e perguntas! Será lançado um novo episódio todos os meses, na primeira segunda feira!');
